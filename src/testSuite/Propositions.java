...
//        Proposition proposition01 = new Proposition("President", "Leader of the country.", 1, options01);
//
//        String[] options02 = new String[]{"Vini Jr.", "Rodri"};
//        Proposition proposition02 = new Proposition("Balon D'Or Winner", "Best soccer player of the world.", 1, options02);
//
//        String[] options03 = new String[]{"Chicken", "Egg"};
//        Proposition proposition03 = new Proposition("Existentialism", "Which really came first?", 1, options03);
//
//        String[] options04 = new String[]{"Math", "English", "History", "Physical Education", "Culinary Arts"};
//        Proposition proposition04 = new Proposition("Favorite Subject", "Which subject was your favorite in school?", 1, options04);
//
//        String[] options05 = new String[]{"Bulbasaur", "Squirtle", "Charmander"};
//        Proposition proposition05 = new Proposition("Starter Pokemon", "This will be your first pokemon for your adventure.", 1, options05);
//

...
public class DeviceManager {
    ...
    public DeviceManager(Printer printer, SDCardDriver sdCard, TamperSensor tamperSensor,
    ...
    private void performCardReaderAction(String deviceName, int choice, String message) throws IOException {
        ...
        switch (choice) {
            case 1:
                ...
                System.out.println("3. Insert Card into " + deviceName + " !include a message, message is card number!");
    ...
    private void performSDCardAction(String deviceName, int choice, String message) throws IOException {
        ...
        switch (choice) {
            case 1:
                ...
                System.out.println("1. Information on " + deviceName);
                System.out.println("2. Simulate " + deviceName + " failure");
                System.out.println("3. Set filePath for " + deviceName + " !include a message, message will set file path!");

...
public class SDCardDriver {
    ...
    public static void main(String[] args) {
        ...
        String filePath = "sdCardDriver.txt";

        // Create an SDCardDriver instance in write mode (Mode.W)
        SDCardDriver writeDriver = new SDCardDriver(filePath, Mode.W);
        ...
        try {
            ...
            SDCardDriver readDriver = new SDCardDriver(filePath, Mode.R);
            ...
            try {
                ...
                System.out.println("Data read from sdCardDriver.txt:");
        ...
        SDCardDriver failureCheckDriver = new SDCardDriver(filePath, Mode.W);
        if (failureCheckDriver.checkForFailure()) {
